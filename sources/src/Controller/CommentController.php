...
use App\Service\Comment\Loader;
...
class CommentController extends AbstractController
{
  ...
  public function update(#[MapRequestPayload] EditCommentDto $dto, Loader $loader): JsonResponse
  {
    $loader->update($dto);
  ...
  public function delete(int $id, Loader $loader): JsonResponse
  {
    $loader->delete($id);
    return $this->json([]);
  }
